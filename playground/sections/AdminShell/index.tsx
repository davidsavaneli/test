...
function BrandLogo() {
  return (
    <svg viewBox="0 0 935 186" fill="currentColor" role="img" aria-label="Techzy">
    ...
    // <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" id="Layer_1" viewBox="0 0 77.89 70">
    //   <path d="M2.05,67.67l.06-5.56c.5-12.92,1.78-26.01,5.45-38.46,1.83-6.23,5.6-16.44,11.33-19.97,6.74-4.16,12.25,2.38,15.25,7.75,2.32,4.16,3.95,8.81,5.23,13.4.09,0,.11-.18.13-.25,2.23-6.75,5.01-15.92,11-20.31,9.83-7.21,16.67,7.44,19.3,14.7,3.47,9.58,5.29,20.46,6.24,30.6.56,6.02.77,12.05.82,18.1h-9.42c-.02-1.44.02-2.89,0-4.33-.17-11.29-.85-22.78-2.6-33.94-.88-5.63-2.12-12.31-4.45-17.5-1.58-3.51-4.39-7.4-7.8-2.84-3.16,4.23-4.87,12.67-5.78,17.87-1.76,10.01-2.55,20.66-2.73,30.82-.03,1.76.03,3.51,0,5.27h-9.36l-.06-6.39c-.4-11.12-1.09-22.36-3.38-33.29-.87-4.17-2.82-12.33-5.93-15.26-4.45-4.2-7.51,5.01-8.43,7.99-2.82,9.08-3.98,19.89-4.69,29.38-.55,7.39-.77,14.8-.77,22.22H2.05Z" />
    // </svg>
  )
}
...
const tableConfigQueryRoute = createRoute({
  getParentRoute: () => tableGroupRoute,
  path: 'config-query',
  staticData: { name: 'Query — App Config', order: 0 },
  component: inPage(TableConfigQueryPage),
})
const tableConfigQueryLocalRoute = createRoute({
  getParentRoute: () => tableGroupRoute,
